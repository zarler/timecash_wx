 ...
 *
 * */
class Controller_App_MyCard extends AppHome
{
    ...
    public function action_BuyList(){
        ...
        parent::$_VArray['title'] = '我的消费卡';
        //购卡页面
        parent::$_VArray['jumpUrl'] = '/app/MyCard/Buy';
        parent::$_VArray['back'] = true;
        //跳转页面(区分微信和app的)
        //分享
    ...
    public function action_Buy(){
        ...
        //发送短信
        parent::$_VArray['codeurl'] = '/app/Functions/BuyCardVerifySMS';
        //购卡提交接口
        parent::$_VArray['submit'] = '/app/Functions/BuyCardSubmit';
        //购卡后跳转页面
        parent::$_VArray['jumpUrl'] = '/app/MyCard/BuyStatus';
    ...
    public function action_BuyStatus(){
        parent::$_VArray['back'] = true;
        parent::$_VArray['url'] = '/app/MyCard/MyList';
