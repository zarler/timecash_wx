 ...
 *
 * */
class Controller_App_MyWallet extends AppHome
{
    ...
    public function action_HomePage(){
        ...
        //跳转页面(区分微信和app的)
        parent::$_VArray['urlCoin'] = '/app/MyWallet/Detailed';
        parent::$_VArray['urlCoupon'] = '/app/CouponList/coupon';
        parent::$_VArray['urlDailyCoupons'] = '/app/Activity/TC0A016?showtitle=111';;
        //提现地址
    ...
    public function action_Detailed(){
        ...
        //跳转页面(区分微信和app的)
        parent::$_VArray['urlHome'] = '/app/MyWallet/HomePage';
        parent::$_VArray['urlExplain'] = '/app/MyWallet/Explain';
        //加载更多
        parent::$_VArray['apiUrl'] = '/wx/Functions/WalletDetailed';
