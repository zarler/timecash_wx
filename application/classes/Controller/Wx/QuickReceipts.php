 ...
 *
 * */
class Controller_Wx_QuickReceipts extends WxHome
{
...
//                Tool::factory('Debug')->D($result);
                ...
                //无银行卡跳转(添加银行卡)
                $this->redirect('/wx/QuickReceipts/addbank');
            }
        }else{
    ...
    public function action_addbank(){
        ...
        parent::$_VArray['requestUrl'] = "/wx/Functions/addbank";
        parent::$_VArray['entrance'] = "/wx/QuickReceipts";
