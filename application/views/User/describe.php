...
<section class="t-login-nav">
	<div class="t-login-nav-1"><a href="<?php echo URL::site('User/index');?>" class="t-return"></a>借款详情</div>
</section>
...
<section class="t-login-center t-mt0px">
	...
	<p class="t-login-center-1 t-bt1px">借款金额<span class="t-loan1"><?php echo (int)$describe['info']['con']['loan_amount'];?>元</span></p>
	...
	<p class="t-login-center-1 t-bt1px">担保金额<span class="t-loan1"><?php echo (int)$describe['info']['con']['ensure_amount'];?>元</span</p>
	<?php } ?>
	...
	<p class="t-login-center-1 t-bt1px">到期还款金额<span class="t-loan1"><?php echo $describe['info']['con']['repayment_amount'];?>元</span></p>
