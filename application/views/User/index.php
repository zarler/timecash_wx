...
<article class="m-pbt">
    ...
    <section class="m-login-center">
        <p class="m-title">我的借款<a href="<?php echo URL::site('User/Index');?>"></a></p>
			...
			<a href="<?php echo URL::site('User/describe');?>">
			...
			<section class="m-toborrow">
				<a href="<?php echo URL::site('Borrowmoney/index');?>" class="t-red-btn m-toborrowbtn">立即借款</a><!-- 这的立即借款可点 !-->
			</section>
			...
			<?php } elseif($info['status']==Model_Home::PAGE_TO_PAY_SUCC){?>
			<a href="<?php echo URL::site('User/describe');?>">
				<div class="m-showinfor">
					<span class="m-border"><em><?php echo (int)$info['con']['loan_amount'];?></em>元</span>
					<span><em><?php echo $info['con']['day'];?></em>天</span>
			...
			<?php  }elseif($info['status']===Model_Home::PAGE_TO_READY){ ?>   <!-- 待审状态 !-->
				<a href="<?php echo URL::site('User/describe');?>">
					<div class="m-showinfor">
						<span class="m-border"><em><?php echo (int)$info['con']['repayment_amount'];?></em>元</span>
						<span><em><?php echo $info['con']['day'];?></em>天</span>
						<i></i>
					</div>
				</a>
			...
			<?php  }elseif($info['status']===Model_Home::PAGE_TO_INIT){ ?>   <!-- 等待预授权 !-->
				<a href="<?php echo URL::site('User/describe');?>">
					<div class="m-showinfor">
						<span class="m-border"><em><?php echo (int)$info['con']['repayment_amount'];?></em>元</span>
						<span><em><?php echo $info['con']['day'];?></em>天</span>
			...
			<p class="m-yuqidate" style="color:red"><?php echo $info['statustext'];?></p>
			</section>
			<section class="m-toborrow">
			...
			<?php  }elseif($info['status']===Model_Home::PAGE_TO_OVERDUE_ACTREPAY_IN){ ?><!-- 逾期主动还款 !-->
			<a href="<?php echo URL::site('User/describe');?>">
				<div class="m-showinfor">
					<span class="m-border"><em><?php echo (int)$info['con']['loan_amount'];?></em>元</span>
					<span><em><?php echo $info['con']['day'];?></em>天</span>
			...
			<?php  }elseif($info['status']===Model_Home::PAGE_TO_OVERDUE_ACTREPAY_FAIL){ ?><!-- 逾期主动还款失败 !-->
			<a href="<?php echo URL::site('User/describe');?>">
				<div class="m-showinfor">
					<span class="m-border"><em><?php echo (int)$info['con']['loan_amount'];?></em>元</span>
					<span><em><?php echo $info['con']['day'];?></em>天</span>
