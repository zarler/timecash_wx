...
<section class="t-login-center hidden">
	<p class="t-withdraw">预借现金可用余额<span><em><?php echo ceil($credit_amount);?></em>元</span></p>
	<div class="t-withdraw1">
		...
		<p class="t-withdraw t-bbn borrowmoney">借款金额<span><em>500</em>元</span></p>
			...
			<div id="js-example-change-value" class="js-change-value">
		        <input name='money' type="range" min="500"  step="100" max="<?php echo $credit_amount;?>" value="<?php echo empty($poundageinfo['loan_amount'])?500:$poundageinfo['loan_amount'];?>" data-rangeslider>
	...
	<div class="t-withdraw1 t-withdraw1-1">
		<p class="t-withdraw t-bbn borrowday">借款期限<span><em>7</em>天</span></p>
		<div class="t-withdraw2">

			 <div id="js-example-change-value-2" class="js-change-value">
                <input type="range" name="day" min="7" max="25" value="<?php echo empty($poundageinfo['day'])?7:$poundageinfo['day'];?>" data-rangeslider-2>
                <div class="t-jinbi" style="display: none">
                    <p class="t-withdraw2-1"><span><output></output></span></p>
                    <div class="t-withdraw2-2"></div>
	...
	<div class="t-withdraw t-withdraw5">
        <span class="x-mt poundage"><em>4990</em>元</span>借款手续费<br><small>(含管理费与利息)</small>
    </div>
	...
	<section class="t-login-center hidden">
		<p class="t-withdraw t-withdraw5 practical">实际放款金额<span><em>500</em>元</span></p>
		<p class="t-withdraw t-withdraw5 t-bbn expire">到期还款金额<span><em>5000</em>元</span></p>
	</section>
...
<script>
    $(function() {
		...
		function practical(){
			...
			N = $('.borrowday em').text();
			//var poundage = (money*day*2/1000).toFixed(2);
			m='<?php echo $formula;?>';
			poundage = eval(m);
			poundage = poundage.toFixed(2);
			$('.practical em').text((K-poundage).toFixed(2));
			$(".t-coup").hide();
			$('.poundage em').text(poundage);
			$('.expire em').text(K);
