...
<section class="m-webbox">
    <a href="<?php echo isset($_VArray['urlWithdrawals'])?$_VArray['urlWithdrawals']:'javascript:;' ?>" class="identify1">
...
<!--	</a>-->
    ...
    <a href="<?php echo isset($_VArray['urlWithdrawals'])?$_VArray['urlWithdrawals']:'javascript:;' ?>" class="button_submit_f">提现</a>
    <div class="top_height"></div>
