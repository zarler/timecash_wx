...
<script>
	seajs.config({
		vars: {
			'gainlastId':<?php echo isset($_VArray['gainlastId'])?$_VArray['gainlastId']:0; ?>,
			'userlastId':<?php echo isset($_VArray['userlastId'])?$_VArray['userlastId']:0; ?>,
			'apiUrl':'<?php echo isset($_VArray['apiUrl'])?$_VArray['apiUrl']:''; ?>',
		}
	});
...
<section class="t-login-nav">
	<div class='t-login-nav-1'>
		<a href="<?php echo $_VArray['urlHome'] ?>" class="return_i i_public"></a>余额明细
		<a href="<?php echo $_VArray['urlExplain'] ?>"><span id="show-rules" style="margin-right: 0.2rem"><i class="problem_i"></i>余额说明</span></a>
	</div>
</section>
<!-- 头信息end -->
...
<!--</div>-->
<div class="GainList">
	<?php if(isset($_VArray['strList'])&&!empty($_VArray['strList'])){?>
		<div class="listshow">
			<?php echo $_VArray['strList']; ?>
		</div>
		<?php if(isset($_VArray['gainlastId'])&&$_VArray['gainlastId']>0){?>
...
<div style="display: none" class="UseList">
	<?php if(isset($_VArray['strUserList'])&&!empty($_VArray['strUserList'])){?>
		<div class="listshow">
			<?php echo $_VArray['strUserList']; ?>
		</div>
		<?php if(isset($_VArray['userlastId'])&&$_VArray['userlastId']>0){?>
