...
<script>
	seajs.config({
		vars: {
            ...
            borrowurl:'<?php echo $_VArray['requestUrl'];?>',
...
<section class="t-login-nav">
	<div class='t-login-nav-1'><a class="return_i i_public" href="/"></a><?php echo $_VArray['title'];?></div>
</section>
...
<section class="t-login-center hidden t-withdraw1">
	<div class="t-withdraw t-withdraw5 WellForm practical border-bottom">担保比例
			<span>
                <nav class="WellCheckBox WellCheckBoxH">
                    <input type="radio" checked='true' disabled name="ensure_rate" value="<?php echo $_VArray['rule']['ensure_rate']?>">
                </nav>
...
<script type="text/javascript">
	;(function(){
		...
		win.GetSwiftNumber=function(data){
			...
			$.ajax({
                url:'<?php echo $_VArray['requestBairong'];?>',
				type:'POST',
