<?php include Kohana::find_file('views', 'v2/public/head');?>
	...
	<section class="rapidly_loan_ban">
		<p class="t-loan" style="height:1.4rem;line-height:1.3rem"><em><small>每天<?php echo date("H:s",$faststatus['today_start']); ?>点开放<?php echo $faststatus['today_max']; ?>单，当前剩余<?php echo ($faststatus['today_max']-$faststatus['today_total'])<0?0:$faststatus['today_max']-$faststatus['today_total'] ?>单。</small></em></p>
	</section>
	...
	<section class="t-login-center hidden t-withdraw1">
		<div class="t-withdraw t-withdraw5 border-bottom">
			<span class="x-mt poundage"><em>39.00</em>元</span>借款手续费<br><small>(含管理费与利息)</small>
		</div>
