...
<!--</section>-->
<p class="c-credit-basics">授信资料</p>
...
<?php }else{?>
	<section class="m-webbox">
		<div class="m-lineblock">
			<i class="m-corporation"></i>
			<label>工作和联系人信息</label>
			<?php if($step['work_info']==2 && $step['contact']==2){echo '<a href="javascript:;" class="identify">已提交</a>';}else{echo '<a style="color: #ff8470" href="/RegisterApp/Company?jump=Account_Promote">未提交</a>';}  ?>
			<i class="inter_i float_right"></i>
		</div>
	</section>
<?php }}else{?>
