...
<head>
    ...
    <script>
        $(function(){
            ...
            max =  <?php echo isset($_VArray['max'])?$_VArray['max']:0 ?>;
...
<div class="pop-wrap js-mask" id="pop-notimes-end" style="display: ;">
    <div class="redrain-pop-mask"></div>
    <div class="redrain-pop">
        <!--        <div class="redrain-pop-close" data-toggle="mask" data-target="js-mask"></div>-->
        <div class="redrain-pop-chance-end"></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function clickSubmit() {
        $.ajax({
            ...
            data:{action:'click',event_name:'TCOA_017'},
            dataType: 'json',
            async: true,  //同步发送请求t-mask
            beforeSend: function () {
            },
